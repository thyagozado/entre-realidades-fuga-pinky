...
const AchievementNotification: React.FC<AchievementNotificationProps> = ({
  ...
  const animationStyles = `
    @keyframes float-medium {
      ...
      50% {
        transform: translateY(-12px); /* Intensidade da flutuação */
      }
    }
    ...
    @keyframes pulse-glow-strong {
      0%, 100% {
        text-shadow: 0 0 10px #ec4899, 0 0 20px #db2777, 0 0 30px #be185d; /* Usando hex para cores do Tailwind Pink */
        opacity: 1;
      }
      50% {
        text-shadow: 0 0 20px #f472b6, 0 0 35px #ec4899, 0 0 50px #db2777;
        opacity: 0.85;
      }
    }
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-90 flex flex-col items-center justify-center z-[100] font-pixel p-4">
        {/* LEVEL UP! Text */}
        <p 
          className="text-6xl sm:text-7xl text-pink-500 mb-4 sm:mb-6 animate-pulse-glow-strong"
        >
          LEVEL UP!
        </p>
        ...
        <img 
          src={pinkySpriteUrl} 
          alt="Pinky" 
          className="w-20 h-20 sm:w-24 sm:h-24 mb-6 sm:mb-8 object-contain animate-float-medium"
        />
